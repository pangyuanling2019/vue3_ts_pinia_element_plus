    ...
    <div ref="containerDom" class="tags-view">
        ...
        >
            <div
                ...
                :class="[
                    'scroll-item',
                    $route.path === item.path ? 'card-active' : '',
                ]"
...
export default {
    setup() {
        let vm: any;
        const { deleteDynamicTag, dynamicRouteTags, dRoutes, routesLength } =
            useDynamicRoutesHook();
        const route = useRoute();
        const router = useRouter();
        const containerDom = templateRef<HTMLElement | null>(
            "containerDom",
            null
        );
        ...
        const setScrollPosition = () => {
            console.log(unref(containerDom));
        };
